...
export default function Home() {
  return (
    <>
      <Head>
        <title>Portfolio | Lishan pasindu</title>
...
<TransitionEffect/>
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:bg-dark ">
        <Layout className="pt-0 md:p-16 sm:p-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full ">
              <Image src={profilePic} alt="Lishan" className="w-full h-auto lg:hidden md:inline-block md:w-full  " 
              priority
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium  dark:text-light md:text-sm sm:text-xs">
                ...
                projects and Qualifications , showcasing my expertise in React.js and
                web development.
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center ">
                <Link href="/LishanPasindu.pdf" target={"_blank"}
                className="flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold 
                border-2 border-solid border-transparent hover:border-dark dark:text-dark dark:bg-light 
                hover:bg-light hover:text-dark md:p-2 md:px-4 md:text-base " 
                download={true}
                >Resume <LinkArrow className={"w-6 ml-1"} />
                
                </Link>
                <Link href="mailto:lishanpc@gmail.com" target={"_blank"}
        ...
        <div className="absolute right-8 bottom-8 inline-block w-24 md:hidden">
          <Image src={LightBulb} alt="Lishan" className="w-full h-auto" />
        </div>
